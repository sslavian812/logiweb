...
//
//            // clear te database:
//            List<DriverEntity> somedrivers = driverManagementService.findAllDrivers();
...
//
//            // check drivers count:
//            List<DriverEntity> drivers = driverManagementService.findAllDrivers();
...
//            List<DriverEntity> empty = driverManagementService.findAllDrivers();
